...
- [ ] Step 3: Content passes (delete-first, sources of truth, routes)
- [ ] Step 4: Behaviour passes (triggering, freedom, verification, permissions)
- [ ] Step 5: Risk passes (supply chain, interference)
- [ ] Step 6: Write the report — verdict, delete list, blockers
```
...
The script covers what is countable. It says nothing about whether the content is worth loading, which is Steps 3–5. Do not let a clean script run become the verdict.

### Steps 3–5: The nine passes
...
| # | Pass | Asks |
|---|---|---|
| 1 | Delete-first | Which lines would be true at any company, or restate what the model already does? |
